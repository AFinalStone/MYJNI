...
JNIEXPORT jint JNICALL Java_com_shi_androidstudy_ndk04_1alipay_MainActivity_pay
  (JNIEnv *env, jobject obj, jstring account, jstring pwd, jint count) {


    // 找到类com.shi.androidstudy.ndk04_alipay.MainActivity
    // jclass (*FindClass)(JNIEnv*, const char*);
    jclass clazz = (**env).FindClass(env, "com/shi/androidstudy/ndk04_alipay/MainActivity");
